...
export const TwoColumnLayout: React.FC<TwoColumnLayoutProps> = ({
  ...
  return (
    <>
      {/* Desktop (≥ 768px) – Figma Frame 1000004350 */}
      <div className="hidden md:flex flex-col items-start p-0 w-full max-w-[1360px] mx-auto">
        <div className="flex flex-row items-start p-0 w-full h-[660px]">
          {imageSrc && (
          ...
          <div className="flex flex-col items-start pt-8 pr-[216px] pb-20 pl-[128px] w-[696px] h-[660px] gap-6">
            <div className="flex flex-col items-start p-0 gap-4 w-[352px]">
              {tag && (
                <div className="inline-flex items-center px-2 py-1 gap-1 bg-gradient-to-r from-[#00F4E2] to-[#00FF7F] rounded text-[#03050F] font-bold text-sm leading-4 tracking-wide">
                  {tag}
                </div>
              )}
              {title && (
                <h1 className="text-[#03050F] font-bold text-[32px] leading-10 w-[352px]">
                  {title}
                </h1>
              )}
              {subtitle && (
                <p className="text-[#03050F] font-semibold text-sm leading-5 tracking-wide w-[352px]">
                  {subtitle}
                </p>
              )}
            </div>
      ...
      {/* Mobile (< 768px) – Figma Frame 1000004345 */}
